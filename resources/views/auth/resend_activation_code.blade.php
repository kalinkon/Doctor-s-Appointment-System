    ...
    <div class="container">
        <div class="">
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="well">
                    <div class="panel-heading" align="center" ><strong>Send Activation Code</strong></div>

                    {{--<div id="alert" class="text-center">--}}
                    {{--@include('flash::message')--}}
                    {{--</div>--}}
                    @include('flash::message')
                    <form class="form-horizontal" method= "POST" action="{{ route('user.send_activation_code') }}">
                        {{ csrf_field() }}
